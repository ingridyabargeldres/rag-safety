...
\end{lstlisting}
  \begin{itemize}
    \item El script fija \texttt{--n-answers=1} (no el default $N{=}5$ de
      \texttt{run\_attack}), por eso cada corrida muestra una sola respuesta
      adversaria en vez de una lista de cinco candidatos.
